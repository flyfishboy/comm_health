        ...
        <el-card v-for="item in tableData" style="width: 60%" align="left">
            <div class="userpto">
                <div v-for="item3 in tableData3" v-if="item.account == item3.account">
                    <el-avatar :src="item3.turl"></el-avatar>
            ...
            <!--回复内容显示-->
            <div>
                <el-button style="margin-top: -40px" @click="findre(item.id)">查看评论</el-button>
                <div>
                    <el-divider content-position="right"></el-divider>
                    <div style="height: 5px"></div>
                    <div style=" background-color: whitesmoke;">
                        <div v-for="item2 in tableData2" v-if="item.id == item2.rid"
                             style="width: 90%;margin-left: 3%;margin-top: 2px" align="left">
