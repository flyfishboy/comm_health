    ...
    export default {
        ...
        methods: {
            ...
            handleAvatarSuccess(response) { //第一个上传的图片的成功的函数
                ...
                if (this.url != '') {
                    this.ruleForm.url = 'http://47.96.141.103:8888/' + response.data.trim();
                    console.log('添加图片' + this.ruleForm.url);
                }else {
                    this.ruleForm.v_url = 'http://47.96.141.103:8888/' + response.data.trim();
                    console.log('添加视频' + this.ruleForm.v_url);
                }
            },
                    ...
                    if (valid) {
                        axios.post('http://localhost:8181/chat/save', this.ruleForm).then(function (resp) {
                            if (resp.data == 'success') {
                                ...
                                console.log(_this.ruleForm.v_url);
