...
<script>
    export default {
        data() {
            return{
                imgHeight:"",
                imgList: [ {id: 0, idView: require('../../assets/1.png')}, {id: 1, name: '详情', idView: require('../../assets/2.jpg')}, {id: 2, name: '推荐', idView: require('../../assets/3.jpg')},{id: 3, idView: require('../../assets/4.png')}, ]
            }
            that.imgHeight = '30px';
